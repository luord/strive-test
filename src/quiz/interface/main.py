...
class Root(MethodView):
    ...
    def post(self):
        ...
        submission = submission_case.create(request.form["quiz_id"], request.form["response"])
...
class Step(MethodView):
    ...
    def post(self):
        ...
        return redirect(url_for('step', step=step))


bp.add_url_rule("/", view_func=Root.as_view("root"))
bp.add_url_rule("/<step>", view_func=Step.as_view("step"))
